...
$logFile = 'C:\Scripts\Shutdown Scripts\HR Daily Shutdown.csv'
...
$successful += Get-SpecopsADComputer -name:$OUFilter.name  | 
               ...
               Stop-SpecopsComputer -Message:"This Computer will shutdown in 3 minutes. Please save any work and logoff. IT Support Department." -ForceCloseApplications -WarningTime:180 -PassThru -ErrorAction:SilentlyContinue -ErrorVariable:cmdErrors | 
